;;; simpc-mode.el --- Prost major mod za C  -*- lexical-binding: t; -*-
;;
;; Preuzeto iz dotfiles-a Alexey Kutepova (Tsoding):
;;   https://github.com/rexim/dotfiles  (.emacs.local/simpc-mode.el)
;; Repo nema LICENSE fajl; ovde stoji za licnu upotrebu, nepromenjen.
;;
;; Zasto postoji: ugradjeni cc-mode je velik i "pametan" -- pokusava da
;; parsira C i cesto pogresi na makroima, pa se zna zaglaviti na velikim
;; fajlovima. Ovaj mod radi samo dve stvari: bojenje po regexp-u i prostu
;; indentaciju po zagradama. 127 linija, nikad se ne zaglavi.
;;
;;; Code:
